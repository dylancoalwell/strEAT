class ApplicationController < ActionController::Base
  ...
  def use_twilio(user, message_text, invitation_id)
    ...
    if invitation_id == nil
      ...
      body_message = "#{current_user.first_name} #{current_user.last_name} has sent you an invitation: http://streat.herokuapp.com/invitations/" + invitation_id.to_s + "/accept"
    end
    puts body_message
